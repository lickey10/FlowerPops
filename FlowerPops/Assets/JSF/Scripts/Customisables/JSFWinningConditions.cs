...
public class JSFWinningConditions : MonoBehaviour {
	...
	IEnumerator gameOver(){
        ...
        if(gm.audioScript.gameOverSoundFx.Length > 0)
		    gm.audioScript.gameOverSoundFx[Random.Range(0,gm.audioScript.gameOverSoundFx.Length-1)].play(); // play the game over fx
